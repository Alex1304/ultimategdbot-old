...
public enum Settings {
	GDEVENTS_ANNOUNCEMENTS_CHANNEL("Specifies in which channel I am supposed to send messages "
			...
			+ "its ID or its tag. Example: `g!setup edit gdevents_announcements_channel #bot_announcements`"),
	GDEVENTS_SUBSCRIBER_ROLE("Specifies which role I am supposed to tag when a new event on GD happens. "
			...
			+ "and I must have the permission to manage this role, or else the `g!gdevents` command won't work! "
			+ "You can provide the role either by giving its name, its ID or by mentionning it directly. "
			+ "Example: `g!setup edit gdevents_subscriber_role @EventSubscribers`");
