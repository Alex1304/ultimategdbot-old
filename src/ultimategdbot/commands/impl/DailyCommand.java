...
/**
 * Displays the current Daily level on Geometry Dash
 * 
 * @author Alex1304
 *
 */
	...
	public void runCommand(MessageReceivedEvent event, List<String> args) throws CommandFailedException {
		try {
			...
			AppTools.sendMessage(event.getChannel(), event.getAuthor().mention()
					+ ", here is the Daily level of today. Next Daily in " + GDUtils.fetchNextTimelyCooldown(true),
					GDUtils.buildEmbedForGDLevel("Daily level #" + GDUtils.fetchCurrentTimelyID(true),
							"https://i.imgur.com/enpYuB8.png", level));
